...
window.addEventListener('load', () => {
    ...
    Record.addEventListener('click', () => {
        // do something when click 'Record'
        // ...
        if(IS_RECORDING === 0){
...
let bgms = [bgm_silence(), bgm_silence(), bgm_Children_Song(), bgm_celebrate(), bgm_lyric(), bgm_folk()];
let changes = [change_nochange, change_nochange, change_backInTime, change_valleyEcho, change_cuteMonster];
/*****************************************************************************/
